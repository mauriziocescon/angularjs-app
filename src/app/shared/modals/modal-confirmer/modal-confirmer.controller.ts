export class ModalConfirmerController {
    ...
    constructor($uibModalInstance: ng.ui.bootstrap.IModalInstanceService, modalTitle: string, modalMessage: string, modalYesButtonLabel: string, modalNoButtonLabel: string) {
